...
t_stack_n	*find_last(t_stack_n *stack) //Define a function that returns the pointer to the last node
{
	if (!stack)
		return (NULL);
...
t_stack_n	*find_min(t_stack_n *stack) //Define a function that searches a stack and returns the node with the smallest number
{
	long			min; //To store the smallest value so far
	t_stack_n	*min_node; //To store a pointer that points to the smallest number
...
t_stack_n	*find_max(t_stack_n *stack) //Define a function that searches a stack and returns the node with the biggest number
{
	long			max; //To store the biggest value so far
	t_stack_n	*max_node; //To store a pointer that points to the biggest number
...
int	stack_len(t_stack_n *stack) //Define a function that calculates and returns the length of a stack
{
...
bool	stack_sorted(t_stack_n *stack) //Define a function that checks if the stack is sorted in ascending order
{
	if (!stack)
		return (1);
	while (stack->next) //Loop until the end of the stack is reached
