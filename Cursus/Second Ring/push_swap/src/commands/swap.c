...
static void	swap(t_stack_n **head) //Define a function that swaps the positions of the top node and second node of a stack
{
...
void	sa(t_stack_n	**a, bool print) //Swap the first two nodes of stack `a` and print the instruction
{
	swap(a);
	if (!print)
		ft_printf("sa\n");
...
void	sb(t_stack_n **b, bool print) //Swap the first two nodes of stack `b` and print the instruction
{
	swap(b);
	if (!print)
		ft_printf("sb\n");
...
void	ss(t_stack_n **a, t_stack_n **b, bool print) //Stimutaneously swap the first two nodes of the stack and print the instruction
{
	swap(a);
	swap(b);
	if (!print)
