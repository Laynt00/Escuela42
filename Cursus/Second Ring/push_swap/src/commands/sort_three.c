...
void	sort_three(t_stack_n **a) //Define a function that handles when stack `a` has three nodes, and sorts it
{
	t_stack_n	*biggest_node; //To store a pointer to the biggest node in stack `a`
